...
<!-- Complaints sectioin -->
    <input id="current-page" type="hidden" value="incoming">
    <div class="col-lg-9 complaints d-flex justify-content-center">
        <div class="container-complaints">
            <div class="scrollbox-complaints">
                <div class="scroll-content d-flex flex-column" id="_scroll-content">
                    <div class="alert text-center alert-success">Complaints moved to working section</div>
    ...
    <!-- My own Javascript -->
    <script src="../scripts/incoming.js"></script>
